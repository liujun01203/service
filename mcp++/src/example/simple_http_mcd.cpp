/*
 * simple_http_mcd.cpp: Simple HTTP Server. An example of MCP++.
 * Date:          2011-03-16
 */
...
public:
  ...
  virtual ~CHttpServerApp() { if ( arg_vals ) free(arg_vals); }
...
void
CHttpServerApp::run(const  string &conf_file)
{
